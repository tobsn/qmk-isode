 ...
 */
	[LAYER_BASE] = KEYMAP( /* Base */
		...
		LSPO_KEY, DE_OSX_Y, DE_OSX_X, DE_OSX_C, DE_OSX_V, DE_OSX_B, DE_OSX_N, DE_OSX_M, DE_OSX_COMM, DE_OSX_DOT, DE_OSX_MINS, RSPC_KEY, \
		KC_LCTRL, KC_LALT,  KC_LGUI,            LT(LAYER_MOD,KC_SPC),         KC_SPC,                KC_RGUI,    KC_RALT,     KC_RCTRL \
	),

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 /* BASE
 * .-----.-----.-----.-----.-----.-----.-----.-----.-----.-----.-----.-----.------.
 * | ESC |  Q  |  W  |  E  |  R  |  T  |  Z  |  U  |  I  |  O  |  P  |  Ü  | BSPC |
 * |-----'.----'.----'.----'.----'.----'.----'.----'.----'.----'.----'.----'.-----|
 ...
 */
	[LAYER_BASE] = KEYMAP( /* Base */
		...
		LSPO_KEY, DE_OSX_Y, DE_OSX_X, DE_OSX_C, DE_OSX_V, DE_OSX_B, DE_OSX_N, DE_OSX_M, DE_OSX_COMM, DE_OSX_DOT, DE_OSX_MINS, MO(LAYER_RSFT), \
		KC_LCTRL, KC_LALT,  KC_LGUI,            LT(LAYER_MOD,KC_SPC),         KC_SPC,                MO(LAYER_RGUI),    KC_RALT,     KC_RCTRL \
	),
